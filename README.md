...
&nbsp;&nbsp;<img width=100 src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/streamlit/streamlit-plain-wordmark.svg" />&nbsp;&nbsp;
  <img width=100 src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mysql/mysql-original-wordmark.svg" />
<div>

Este repositório foi criado para alocar arquivos de estudo do curso de SQL realizado e futuramente projetos envolvendo bancos de dados e consumos de APIs simples.
